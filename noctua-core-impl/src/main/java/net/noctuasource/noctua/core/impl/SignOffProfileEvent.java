...
/**
 * An event that is posted, when the user signed off.
 * @author Philipp Thomas
 */
public class SignOffProfileEvent extends AbstractControllerEvent {
	 ...
	 * Constructor.
	 */
	public SignOffProfileEvent(Profile profile) {
