...
/**
 * Global noctua paths for linux.
 * @author thomy
 */
public class GlobalPathsUnixImpl implements GlobalPaths {
	...
	public GlobalPathsUnixImpl() {
		String homeDir = System.getProperty("user.home");
		storeDir = new File(homeDir + File.separator + "." + STORE_DIR).getAbsolutePath();
	}
